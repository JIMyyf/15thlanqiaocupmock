...
/* USER CODE BEGIN 0 */
uint8_t USART1_RECEIVE_DATA[USART1_RECEIVE_BUUFER_SIZE];
char USART1_RECEIVE_ARRAY[USART1_RECEIVE_LENGTH];
uint16_t USART1_RECEIVE_STATE = 0;
/* USER CODE END 0 */
...
void MX_USART1_UART_Init(void)
{
  ...
  memset(USART1_RECEIVE_ARRAY, '\0', sizeof(USART1_RECEIVE_ARRAY));
...
{
  HAL_UART_Transmit(&huart1, (uint8_t *)&ch, 1, 0x00A);
  return ch;
}
/* USER CODE END 1 */
